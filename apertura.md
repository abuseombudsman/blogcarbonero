...
title: "Contenido: Apertura"
name: apertura
description: Contenido que responde al tema apertura
tags: apertura
author: CAPeñarol
---

<h1 style="font-family:fantasy;font-style:italic;color:#000;background:yellow;font-size:1.8em;margin-top:20px;margin-bottom:20px;" class="rounded"> Contenido: Apertura</h1>
<br>
<br>

<ul>
{% for post in site.categories.apertura %}
